...
if __name__ == "__main__":
    ...
    print(solution.smallestEquivalentString("hello", "world", "hold")) # "hdld"
    print(solution.smallestEquivalentString("leetcode", "programs", "sourcecode")) # "aauaaaaada"
