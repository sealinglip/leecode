...
if __name__ == "__main__":
    solution = Solution()
    # ["kingston(0)","kingston","kingston(1)"]
    print(solution.getFolderNames(["kingston(0)", "kingston", "kingston"]))
    # ['pes(2)', 'pes(4)', 'pes', 'pes(2)', 'pes(1)', 'pes(3)', 'pes(5)', 'pes(6)', 'fifa', 'gta', 'pes(2019)']
    print(solution.getFolderNames(
        ["pes(2)", "pes(4)", "pes", "pes(2)", "pes", "pes", "pes", "pes(6)", "fifa", "gta", "pes(2019)"]))
