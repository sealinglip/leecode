    ...
    def numSub(self, s: str) -> int:
        ...
        for c in s:
            if c == '1':
                ...
                res += (continuousOnes * (continuousOnes+1)) >> 1
                continuousOnes = 0
        if continuousOnes:
            res += (continuousOnes * (continuousOnes+1)) >> 1
...
if __name__ == "__main__":
    solution = Solution()
    print(solution.numSub("0110111")) # 9
    print(solution.numSub("101")) # 2
    print(solution.numSub("111111")) # 21
    print(solution.numSub("000")) # 0
