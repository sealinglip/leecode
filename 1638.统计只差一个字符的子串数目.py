...
if __name__ == "__main__":
    solution = Solution()
    print(solution.countSubstrings("aba", "baba"))  # 6
    print(solution.countSubstrings("ab", "bb"))  # 3
    print(solution.countSubstrings("a", "a"))  # 0
    print(solution.countSubstrings("abe", "bbc"))  # 10
