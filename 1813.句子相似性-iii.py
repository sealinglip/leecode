...
class Solution:
    def areSentencesSimilar(self, sentence1: str, sentence2: str) -> bool:
        ...
        l = 0
        while l < len(words1) and l < len(words2) and words1[l] == words2[l]:
            l += 1
        r = 0
        while r < len(words1)-l and r < len(words2)-l and words1[-1-r] == words2[-1-r]:
            r += 1
        return l + r == min(len(words1), len(words2))
        # @lc code=end
