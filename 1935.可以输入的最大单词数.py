...
class Solution:
    def canBeTypedWords(self, text: str, brokenLetters: str) -> int:
        ...
        res = 0
        pattern = re.compile(f'[{brokenLetters}]')
        for word in words:
...
if __name__ == "__main__":
    solution = Solution()
    print(solution.canBeTypedWords("adc de", "")) # 1
    print(solution.canBeTypedWords("hello world", "ad")) # 1
    print(solution.canBeTypedWords("leet code", "lt")) # 1
    print(solution.canBeTypedWords("leet code", "e")) # 0