...
class StockPrice:
    ...
    def update(self, timestamp: int, price: int) -> None:
        if timestamp in self.tsMap:
            self.prices.discard(self.tsMap[timestamp])
        elif self.maxTs < timestamp:
            self.maxTs = timestamp
        self.tsMap[timestamp] = price
        self.prices.add(price)

    def current(self) -> int:
        return self.tsMap[self.maxTs]
