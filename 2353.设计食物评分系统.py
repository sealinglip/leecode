...
class FoodRatings:
    ...
    def __init__(self, foods: List[str], cuisines: List[str], ratings: List[int]):
        ...
        for f, c, r in zip(foods, cuisines, ratings):
            self.foodMap[f] = (r, c)
            self.ratingMap[c].add((self.n - r, f))
        
    def changeRating(self, food: str, newRating: int) -> None:
        r, c = self.foodMap[food]
        self.ratingMap[c].remove((self.n - r, food))
        self.foodMap[food] = (newRating, c)
        self.ratingMap[c].add((self.n - newRating, food))
