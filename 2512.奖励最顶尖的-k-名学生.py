...
class Solution:
    def topStudents(self, positive_feedback: List[str], negative_feedback: List[str], report: List[str], student_id: List[int], k: int) -> List[int]:
        ...
        scores = [-score(r) for r in report]
        return [id for _, id in sorted(zip(scores, student_id))[:k]]


        # @lc code=end
if __name__ == "__main__":
    solution = Solution()
    print(solution.topStudents(["smart", "brilliant", "studious"], ["not"], [
          "this student is studious", "the student is smart"], [1, 2], 2))  # [1,2]
    print(solution.topStudents(["smart", "brilliant", "studious"], ["not"], [
          "this student is not studious", "the student is smart"], [1, 2], 2))  # [2,1]
