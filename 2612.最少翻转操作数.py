...
if __name__ == "__main__":
    solution = Solution()
    print(solution.minReverseOperations(4, 0, [1,2], 4)) # [0,-1,-1,1]
    print(solution.minReverseOperations(5, 0, [2,4], 3)) # [0,-1,-1,-1,-1]
    print(solution.minReverseOperations(4, 2, [0,1,3], 1)) # [-1,-1,0,-1]
