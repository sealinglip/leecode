#
# @lc app=leetcode.cn id=2920 lang=python3
#
# [2920] 收集所有金币可获得的最大积分
#
...
class Solution:
    def maximumPoints(self, edges: List[List[int]], coins: List[int], k: int) -> int:
        ...
        @cache
        def dfs(i: int, j: int, parent: int) -> int:
            res1 = (coins[i] >> j) - k
            res2 = coins[i] >> (j+1)
...
if __name__ == "__main__":
    solution = Solution()
    print(solution.maximumPoints([[0,1],[1,2],[2,3]], [10,10,3,3], 5)) # 11
    print(solution.maximumPoints([[0,1],[0,2]], [8,4,4], 0)) # 16
