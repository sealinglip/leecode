...
if __name__ == "__main__":
    solution = Solution()
    print(solution.largestSquareArea([[1,1],[2,2],[3,1]], [[3,3],[4,4],[6,6]])) # 1
    print(solution.largestSquareArea([[1,1],[2,2],[1,2]], [[3,3],[4,4],[3,4]])) # 1
    print(solution.largestSquareArea([[1,1],[3,3],[3,1]], [[2,2],[4,4],[4,2]])) # 0
