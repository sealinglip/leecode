#
# @lc app=leetcode.cn id=3453 lang=python3
#
# [3453] 分割正方形 I
#
...
class Solution:
    def separateSquares(self, squares: List[List[int]]) -> float:
        ...
        totalWidth = 0.0 # 当前扫描线切割的正方形边长和
        accumArea = 0.0 # 当前累计面积（扫描线以下的）
        prevY = 0.0 # 前扫描线的纵坐标

        for y, l, flag in evts:
            delta = y - prevY
            # 两条扫描线之间新增的面积
...
if __name__ == "__main__":
    solution = Solution()
    print(solution.separateSquares([[0,0,1],[2,2,1]])) # 1.00000
    print(solution.separateSquares([[0,0,2],[1,1,1]])) # 1.16667