...
Author: Thomas Young
Date: 2020-09-01 08:17:43
LastEditors: Thomas Young
LastEditTime: 2020-09-01 08:57:37
'''
#
...
# 然后玩家 1 拿，…… 每次一个玩家只能拿取一个分数，分数被拿取之后不再可取。直到没有剩余分数可取时游戏结束。最终获
# 得分数总和最多的玩家获胜。给定一个表示分数的数组，预测玩家1是否会成为赢家。你可以假设每个玩家的玩法都会使他的分
# 数最大化。
