...
class Solution:
    def numberOfLines(self, widths: List[int], s: str) -> List[int]:
        ...
        for c in s:
            idx = ord(c) - ord('a')
            if widths[idx] + lastWidth > 100:
                lines += 1
                lastWidth = 0
            lastWidth += widths[idx]
        if lastWidth > 0:
            lines += 1
...
if __name__ == "__main__":
    solution = Solution()
    print(solution.numberOfLines([10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10,
                                  10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10],
                                 "abcdefghijklmnopqrstuvwxyz"))  # [3, 60]
    print(solution.numberOfLines([4, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10,
                                  10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10],
                                 "bbbcccdddaaa"))  # [2, 4]
