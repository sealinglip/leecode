...
Author: Thomas Young
Date: 2020-10-21 08:40:17
LastEditors: Thomas Young
LastEditTime: 2020-10-21 08:51:44
'''
#
...
class Solution:
    def isLongPressedName(self, name: str, typed: str) -> bool:
        ...
        while pName < lenName and pTyped < lenTyped:
            cName = name[pName]
            cTyped = typed[pTyped]
            ...
            if cName != cTyped:
                ...
                cnt = 0
                while pName < lenName and name[pName] == cName:
                    pName += 1
                    cnt += 1
                
                cnt2 = 0
                while pTyped < lenTyped and typed[pTyped] == cTyped:
                    pTyped += 1
                    cnt2 += 1
        ...
        return pName == lenName and pTyped == lenTyped
