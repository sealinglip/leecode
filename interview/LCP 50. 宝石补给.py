...
# 每位勇者初始都拥有一些能量宝石， gem[i] 表示第 i 位勇者的宝石数量。现在这些勇者们进行了一系列的赠送，operations[j] = [x, y] 表示在第 j 次的赠送中
...
if __name__ == "__main__":
    solution = Solution()
    print(solution.giveGem([3, 1, 2], [[0, 2], [2, 1], [2, 0]]))  # 2
    print(solution.giveGem([100, 0, 50, 100], [
          [0, 2], [0, 1], [3, 0], [3, 0]]))  # 75
    print(solution.giveGem([0, 0, 0, 0], [
          [1, 2], [3, 1], [1, 2]]))  # 0
